...
var PLUGINS_LOCALPATH = './static/plugins/';
var loadedFiles = [];
  ...
  $.extend($.fn, {
    ...
    themeCustom: function(refresh) {
      ...
      context.find('.theme-colours a').click(function() {
        ...
        if (c !== defaultColour) {
          context.find('#colour-scheme').attr('href', 'static/css/colour-' + c + '.css?x=' + cacheBuster);
        } else {
      ...
      context.find('[data-accordion-focus]').on('shown.bs.collapse', function(e) {
        var headingTop = $(e.target).offset().top;
          ...
          if ($sliderRevolutions.length > 0) {
            var themePluginSliderRevolutionInit = function() {
              ...
              $sliderRevolutions.each(function() {
                ...
                sliderRevEl.show().revolution(sliderRevSettings);
              });
            };
