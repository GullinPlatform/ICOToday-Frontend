        ...
        <div class="header-inner container">
          ...
          <div class="header-brand flex-first">
            <router-link :to="{ name: 'landing'}" class="header-brand-text header-brand-text-sm">
              <h1>
                <span>Deep</span>Computation
              </h1>
            </router-link>
            <div class="header-divider hidden-md-down"></div>
            <div class="header-slogan hidden-md-down m-t">深度计算</div>
          </div>
            ...
            <div class="navbar-main">
              ...
              <ul class="nav navbar-nav navbar-inverse">
                <li class="nav-item d-lg-flex dropdown" v-if="login_status">
                  ...
                  <div class="dropdown-menu dropdown-menu-right dropdown-menu-nobullets">
                    <router-link :to="{name:'me_new_question'}" class="dropdown-item">
                      <i class="fa fa-plus dropdown-icon" aria-hidden="true"></i>新的项目</router-link>
                    <router-link :to="{name:'me'}" class="dropdown-item">
                      <i class="fa fa-drupal dropdown-icon" aria-hidden="true"></i>我的项目</router-link>
                    <router-link :to="{name:'me_settings'}" class="dropdown-item">
                      <i class="fa fa-paint-brush dropdown-icon" aria-hidden="true"></i>个人中心</router-link>
                ...
                <li class="nav-item d-lg-flex hidden-md-down" v-if="!login_status">
                  <a data-toggle="modal" data-target="#login-modal" class="nav-link">登录</a>
                </li>
              </ul>
            </div>
            <button data-toggle="modal" data-target="#signup-modal" class="btn btn-primary btn-rounded btn-sm font-weight-bold" v-if="!login_status">注册</button>
