<template>
    <div class="row">
        ...
        <div class="col-md-8" v-if="me.type===0">
            ...
            <h4>Basic Info <a @click="edit=!edit" class="btn btn-secondary btn-sm float-right"><i
                    ...
                    <div class="col-6 col-sm-4 col-md-3 grid-item" v-for="member in team_members"
                        ...
                        <div class="team-member">
                            <a href="team-member.htm">
                                <img :src="member.avatar" width="100" height="100" class="img-thumbnail">
                            </a>
                            <h5 class="name">
                                <a href="team-member.htm"
                                   title="View Jimi's profile">{{member.first_name}} {{member.last_name}}</a>
                            </h5>
